...
//}
//
//func (m *CandleAggregateService) ProcessTick(symbol string, tickTime int64, tickData model.TickModel) {
//	m.mu.RLock()
...
//		candle, exists = m.candles[symbol]
//		if !exists {
//			alignedStartTime := (tickData.EventTime / 60000) * 60000
...
//	var err error
//
//	if price, err = decimal.NewFromString(tickData.Price); err != nil {
//		log.Printf("Error parsing price: %v\n", err)
//		return
//	}
//	if quantity, err = decimal.NewFromString(tickData.Volume); err != nil {
...
//
//		newStartTime := (tickData.EventTime / 60000) * 60000
//		candle.ResetForNextMinute(newStartTime, 60000)
//	}
//
//	candle.Update(price, quantity, tickData.IsTakerBuy)
